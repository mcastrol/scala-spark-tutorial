...
object AirportsByLatitudeProblem {
  ...
  def main(args: Array[String]) {
    ...
    val airportsLatitudGreater40 = airports.filter(line => line.split(Utils.COMMA_DELIMITER)(6).toFloat > 40)

    val airportsNameAndLatitude = airportsLatitudGreater40.map(line => {
